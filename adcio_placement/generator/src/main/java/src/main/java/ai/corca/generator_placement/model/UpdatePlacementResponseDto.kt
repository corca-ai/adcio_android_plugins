...
data class UpdatePlacementResponseDto (

    @Json(name = "displayFormatHeight")
    val displayFormatHeight: java.math.BigDecimal?,

    @Json(name = "supportEnvironment")
    val supportEnvironment: UpdatePlacementResponseDto.SupportEnvironment,

    @Json(name = "developEnvironment")
    val developEnvironment: UpdatePlacementResponseDto.DevelopEnvironment,

    @Json(name = "title")
    val title: kotlin.String,

    @Json(name = "type")
    val type: UpdatePlacementResponseDto.Type,

    @Json(name = "pageName")
    val pageName: kotlin.String,

    @Json(name = "suggestionType")
    val suggestionType: UpdatePlacementResponseDto.SuggestionType,
    ...
    val bannerPlacementType: UpdatePlacementResponseDto.BannerPlacementType?,
    ...
    @Json(name = "property")
    val `property`: UpdatePlacementResponseDto.`Property`?,
