...
import ai.corca.generator_placement.model.PlacementFormat
import ai.corca.generator_placement.model.WidgetValue
...
data class SuggestionResponsePlacementType (

    @Json(name = "displayFormatHeight")
    val displayFormatHeight: java.math.BigDecimal?,

    @Json(name = "supportEnvironment")
    val supportEnvironment: SuggestionResponsePlacementType.SupportEnvironment,

    @Json(name = "developEnvironment")
    val developEnvironment: SuggestionResponsePlacementType.DevelopEnvironment,

    @Json(name = "title")
    val title: kotlin.String,

    @Json(name = "type")
    val type: SuggestionResponsePlacementType.Type,

    @Json(name = "pageName")
    val pageName: kotlin.String,

    @Json(name = "suggestionType")
    val suggestionType: SuggestionResponsePlacementType.SuggestionType,
    ...
    val bannerPlacementType: SuggestionResponsePlacementType.BannerPlacementType?,
    ...
    @Json(name = "property")
    val `property`: SuggestionResponsePlacementType.`Property`?,
    ...
    @Json(name = "placementFormat")
    val placementFormat: PlacementFormat?,
    ...
    @Json(name = "widgetValue")
    val widgetValue: WidgetValue? = null
