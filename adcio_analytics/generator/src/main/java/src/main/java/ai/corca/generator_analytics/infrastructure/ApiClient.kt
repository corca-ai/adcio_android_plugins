package ai.corca.generator_analytics.infrastructure

import ai.corca.generator_analytics.auth.HttpBearerAuth
import okhttp3.Call
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "ai.corca.generator_analytics.baseUrl"
