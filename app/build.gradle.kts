...
dependencies {
    ...
    implementation("io.github.corca-ai:adcio_placement:0.1.2")
    implementation("io.github.corca-ai:adcio_agent:0.1.2")
    implementation("io.github.corca-ai:adcio_agent_compose:0.1.3")
}
